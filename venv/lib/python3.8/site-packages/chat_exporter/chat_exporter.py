...
async def raw_export(
    ...
    guild: discord.Guild = None,
    set_timezone: str = "Asia/Hong_Kong"
):
    if guild:
        channel.guild = guild
...
async def quick_export(
    ...
    # noinspection PyBroadException
    try:
        transcript = await Transcript.export(channel, None, "Asia/Hong_Kong")
    except Exception:
        traceback.print_exc()
...
class Transcript:
    ...
    async def export(
        ...
        channel: discord.TextChannel,
        limit: Optional[int],
        timezone_string: str = "Asia/Hong_Kong"
    ) -> "Transcript":
        if limit:
